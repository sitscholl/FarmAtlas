...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <>
      <div
        className={`fixed inset-0 z-30 bg-slate-900/30 transition-opacity duration-300 md:hidden ${
      ...
      <aside
        className={`fixed left-0 top-0 z-40 flex h-screen w-72 flex-col border-r border-[color:var(--sidebar-border)] bg-[color:var(--sidebar)] px-4 py-6 shadow-[var(--shadow-soft)] transition-transform duration-300 ${
